...
public class MainActivity extends Activity {
    ...
    private View makeUi() {
        ...
        TextView sub=new TextView(this); sub.setText("R8 II sidecar · NetShare VPN 유지 · 자체 VPN 없음 · v1.4 FINAL"); sub.setTextSize(14); sub.setPadding(0,dp(4),0,dp(18)); root.addView(sub);
        ...
        Button restart=new Button(this); restart.setText("브리지 다시 시작"); restart.setOnClickListener(v->{ stopService(new Intent(this,BridgeService.class)); new Handler(Looper.getMainLooper()).postDelayed(this::startBridge,700); }); root.addView(restart);
